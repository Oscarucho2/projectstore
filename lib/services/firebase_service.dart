...
class FirebaseService {
  ...
  Future<bool> removeItemFromCart(String productName) async {
    try {
      CollectionReference cartCollection = db.collection('car');

      QuerySnapshot querySnapshot =
          await cartCollection.where('product', isEqualTo: productName).get();
  ...
  Future<List<Map<String, dynamic>>> getProductosPorCategoria(
